...
namespace SevenCrowns.Map
{
    ...
    {
        /// <summary>
        /// Event fired when cursor hints change. Args: (hoverHero, moveHint, collectHint).
        /// </summary>
        event Action<bool, bool, bool> CursorHintsChanged;
        ...
        /// <summary>True when the pointer is over a collectable resource node.</summary>
        bool CollectHint { get; }
    }
}

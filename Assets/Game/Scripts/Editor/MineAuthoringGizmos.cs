...
{
    /// <summary>
    /// Editor gizmos for MineAuthoring to preview the flag sprite position from entry.
    /// </summary>
    public static class MineAuthoringGizmos
    {
        [DrawGizmo(GizmoType.Selected)]
        private static void DrawSelected(MineAuthoring target, GizmoType gizmoType)
        {
            if (target == null) return;

            var t = typeof(MineAuthoring);
